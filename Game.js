...
class Game {
    ...
    bindInput() {
        window.addEventListener('keydown', (e) => {
            ...
            // Unfocus any button to prevent accidental clicks
            if (document.activeElement && document.activeElement.tagName === 'BUTTON') {
                document.activeElement.blur();
            }

            // Prioritize e.code for consistent physical key mapping
            // But also support e.key for fallback or specific chars like [ ]
